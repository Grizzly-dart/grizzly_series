...
void main() {
  group('IntSeries.MathOps', () {
    ...
    test('add.StrIndex', () {
      ...
      //TODO expect(s3.indices, ['one', 'two', 'three', 'four']);
    });
    ...
    test('gt.NonIdenticalIndex', () {
      final s1 = new IntSeries<int>([1, 2, 3], indices: [0, 1, 1]);
      final s2 = new IntSeries<int>([5, 4, 3], indices: [0, 1, 0]);
